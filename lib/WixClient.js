...
function BaseWixAPIObject() {
    ...
    this.TYPES = {
         ...
         * @constant
         */
        SUBSCRIPTION_FORM : new ActivityType("contact/subscription-form"),
        /**
         ...
         * @constant
         */
        DOWNLOADS_DOWNLOADED : new ActivityType("downloads/downloaded"),
        /**
         ...
         * @constant
         */
        ECOMMERCE_CART_ADD: new ActivityType("e_commerce/cart-add"),
        /**
         * indicates an item was removed from the cart through ecommerce
         * @constant
         */
        ECOMMERCE_CART_REMOVE : new ActivityType("e_commerce/cart-remove"),
        /**
         * indicates a cart was checked out through ecommerce
         * @constant
         */
        ECOMMERCE_CART_CHECKOUT : new ActivityType("e_commerce/cart-checkout"),
        /**
         * indicates a cart has been abandoned through ecommerce
         * @constant
         */
        ECOMMERCE_CART_ABANDON : new ActivityType("e_commerce/cart-abandon"),
        /**
         * indicates a purchase was made through ecommerce
         * @constant
         */
        EVENTS_EVENT_UPDATE : new ActivityType("events/event-update"),
        /**
         ...
         * @constant
         */
        HOTELS_RESERVATION: new ActivityType("hotels/reservation"),
        /**
         ...
         * @constant
         */
        SCHEDULER_CONFIRMATION: new ActivityType("scheduler/confirmation"),
        /**
         * indicates an appointment has been cancelled
         * @constant
         */
        SCHEDULER_CANCEL: new ActivityType("scheduler/cancel"),
        /**
...
function Contacts(wixApi) {
    ...
    this.getContacts = function(cursor, options) {
        ...
        if(options !== undefined && options !== null) {
            ...
            if(options.fields !== undefined && options.fields !== null) {
                request.withQueryParam("fields", options.fields);
            }
            ...
            if(options.name !== undefined && options.name !== null) {
                if (options.name.first !== undefined && options.name.first !== null) {
                    request.withQueryParam("name.first", options.name.first);
                }

                if (options.name.last !== undefined && options.name.last !== null) {
                    request.withQueryParam("name.last", options.name.last);
                }
            }
        }
        var wixApi = this;
    ...
    /**
     * Get Contacts Mailing List Query Options
     * @typedef {Object} GetContactsMailingListOptions
     * @property {?Number} pageSize - The number of results to return per page of data. Valid options are: 25, 50 and 100. Defaults to 25
     ...
     * @param {string} cursor The current cursor
     * @param {GetContactsMailingListOptions} options getContactsMailingList query options
     * @returns {Promise.<WixPagingData, error>} A promise for a {@link WixPagingData} object to navigate results, or an error
     */
    this.getContactsMailingList = function(cursor, options) {
        var request = this.createRequest("GET", "/v1/contacts/mailinglist");
        if(cursor !== undefined && cursor !== null) {
            request.withQueryParam("cursor", cursor);
        }
        if(options !== undefined && options !== null) {
        ...
        return this.resourceRequest(request, function(data) {
            return new WixPagingData(data, function(cursor) {
                return wixApi.getContactsMailingList(cursor);
            });
        });
    };
    ...
    /**
     * Reconciles a Contact and returns back the full contact object + details
     * @param {object} contact JSON representing the Contact
     * @returns {Promise.<Object, error>} A new Contact, or an error
     */
    this.reconcile = function(contact) {
        var request = this.createRequest("POST", "/v1/contacts");
        var deferred = q.defer();
        request.withVersionNumber("2.0.0");
        request.withPostData(JSON.stringify(contact.toJson()));
        request.asWixHeaders();
        var options = request.toHttpsOptions();
        rest.postJson('https://' + options.host + options.path, contact.toJson(), {
...
function Sites(wixApi) {
    ...
    /**
     * Returns all the settings of the site.
     * @returns {*}
     */
    this.getSiteSettings = function() {
        var api = this;
        return this.resourceRequest(api.createRequest("GET", "/v1/sites/site/settings"),null);
    };
}
