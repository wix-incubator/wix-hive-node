...
function Contacts() {
     ...
     */
    this.newContact = function(wixApi) {
        return new Contact(wixApi);
    };
}
...
var Contact = function(wixApi) {
    ...
    this.compactObject = function(o) {
        ...
        _.each(clone, function(v, k) {
            if(!v || v === undefined || v == null || v.size == 0 || _.isEmpty(v)) {
                delete clone[k];
            }
        });
        return clone;
...
Contact.prototype.toJson = function() {
    var retVal =  {
        ...
        labels: this.getJson(this.labels()),
...
//
//    return this.wixApi.Contacts.save(this);
//};
...
Contact.prototype.addActivity = function(activity) {
    ...
    var deferred = q.defer();
    var request = this.createRequest("POST", "/v1/contacts/" + this.id() + "/activity");
