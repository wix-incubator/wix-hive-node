...
//            it('should create new Contact without throwing errors', function(done) {
//                var contact = api.Contacts.newContact();
//                contact.name({first: 'Karen', last: 'Meep'});
...
//            });
//
//            it('should return existing Contact', function(done) {
//                var contact = api.Contacts.newContact();
...
//                it('should save new Contact and return it with id', function(done) {
//                    var contact = api.Contacts.newContact();
//                    contact.name({first: 'Karen', last: 'Meep'});
//                    contact.addEmail({tag: 'work', email: 'karenc@wix.com'});
...
//                });
                ...
                it('should edit existing contact information', function (done) {
                    var contact = api.Contacts.create(api.Contacts.newContact()).then(
                        function(contact){
                            contact.name({first: 'Karen', last: 'Meep'});
                            contact.addEmail({tag: 'work', email: 'karenc@wix.com'});
                            contact.addEmail({tag: 'work', email: 'karen@home.com'});
...
//                it('should create Contact without throwing errors', function(done) {
//                    var contact = api.Contacts.newContact();
//                    contact.name({first: 'Karen', last: 'Meep'});
//                    contact.addEmail({tag: 'work', email: 'karenc@wix.com'});
//                    contact.addEmail({tag: 'home', email: 'karen@home.com'});
